package com.example.fatcamtel.activities;
...
public class SigninActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SigninActivity.this, com.example.fatcamtel.activities.SignupActivity.class);
    ...
    protected void onRestart() {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            ...
            Intent intent = new Intent(SigninActivity.this, com.example.fatcamtel.MainActivity.class);
            startActivity(intent);
            finish();
        }
    }
